  ...
  return (
    <div id="about">
      ...
      <p><span role="img" aria-label="star-emoji">✨ </span> </p> */}
        ...
        <h2 className="header-title">A bit more about me and Things I l<Heart color="#ff6666"/>ve</h2>
